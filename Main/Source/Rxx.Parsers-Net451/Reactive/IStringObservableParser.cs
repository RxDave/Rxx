...
namespace Rxx.Parsers.Reactive
{
  ...
  [ContractClass(typeof(IStringObservableParserContract<>))]
  public interface IStringObservableParser<out TResult> : IObservableParser<char, TResult>
  {
    /// <summary>
    /// Gets a parser with a grammar that matches any character.
    /// </summary>
    IObservableParser<char, char> AnyCharacter { get; }
    ...
    /// </summary>
    IObservableParser<char, string> WhiteSpace { get; }
    ...
    /// </summary>
    IObservableParser<char, string> InsignificantWhiteSpace { get; }
    ...
    IObservableParser<char, string> AnyCharacterUntil(params char[] stops);
    ...
    /// or the sequence ends.</returns>
    IObservableParser<char, string> AnyCharacterUntil(params string[] stopWords);
    ...
    IObservableParser<char, string> Word(string value);
    ...
    IObservableParser<char, char> Character(char value);
    ...
    IObservableParser<char, char> Character(Func<char, bool> predicate);
    ...
    IObservableParser<char, char> Character(UnicodeCategory category);
  }

  [ContractClassFor(typeof(IStringObservableParser<>))]
  internal abstract class IStringObservableParserContract<TResult> : IStringObservableParser<TResult>
  {
    ...
    public IObservableParser<char, char> Character(UnicodeCategory category)
    {
      Contract.Ensures(Contract.Result<IObservableParser<char, char>>() != null);
      return null;
    }
