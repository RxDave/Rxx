...
{
  internal sealed class AllUnorderedObservableParser<TSource, TResult> : IObservableParser<TSource, IObservable<TResult>>
  {
    ...
    #region Constructors
    public AllUnorderedObservableParser(IEnumerable<IObservableParser<TSource, TResult>> parsers)
    {
