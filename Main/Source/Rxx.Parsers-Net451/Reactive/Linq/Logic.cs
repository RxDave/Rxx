...
namespace Rxx.Parsers.Reactive.Linq
{
  public static partial class ObservableParser
  {
    ...
    public static IObservableParser<TSource, TResult> Or<TSource, TResult>(
      this IObservableParser<TSource, TResult> parser,
      IObservableParser<TSource, TResult> nextParser)
    {
      Contract.Requires(parser != null);
      ...
      var left = new List<IObservableParser<TSource, TResult>>();
      var right = new List<IObservableParser<TSource, TResult>>();

      var nestedLeft = parser as AnyObservableParser<TSource, TResult>;
      var nestedRight = nextParser as AnyObservableParser<TSource, TResult>;
    ...
    public static IObservableParser<TSource, TResult> Any<TSource, TResult>(
      this IEnumerable<IObservableParser<TSource, TResult>> parsers)
    {
      Contract.Requires(parsers != null);
      Contract.Ensures(Contract.Result<IObservableParser<TSource, TResult>>() != null);

      return new AnyObservableParser<TSource, TResult>(parsers);
    }
    ...
    /// <returns>A parser that yields the matches from the first parser in <paramref name="parsers"/> that is successful.</returns>
    public static IObservableParser<TSource, TResult> Any<TSource, TResult>(
      params IObservableParser<TSource, TResult>[] parsers)
    {
      Contract.Requires(parsers != null);
      Contract.Ensures(Contract.Result<IObservableParser<TSource, TResult>>() != null);
      ...
      IObservableParser<TSource, TResult> nextParser)
    {
      ...
      var left = new List<IObservableParser<TSource, TResult>>();
      var leftMany = new List<IObservableParser<TSource, IObservable<TResult>>>();
      var nestedLeft = parser as AllObservableParser<TSource, TResult>;
      var nestedLeftMany = parser as AllManyObservableParser<TSource, TResult>;
    ...
    public static IObservableParser<TSource, IObservable<TResult>> AndUnordered<TSource, TResult>(
      this IObservableParser<TSource, TResult> parser,
      IObservableParser<TSource, TResult> otherParser)
    {
      Contract.Requires(parser != null);
    ...
    public static IObservableParser<TSource, IObservable<TResult>> All<TSource, TResult>(
      this IEnumerable<IObservableParser<TSource, TResult>> parsers)
    {
      Contract.Requires(parsers != null);
      Contract.Ensures(Contract.Result<IObservableParser<TSource, IObservable<TResult>>>() != null);

      return new AllObservableParser<TSource, TResult>(parsers);
    }
    ...
    /// or no matches if any of the parsers have no matches.</returns>
    public static IObservableParser<TSource, IObservable<TResult>> All<TSource, TResult>(
      this IEnumerable<IObservableParser<TSource, IObservable<TResult>>> parsers)
    {
      Contract.Requires(parsers != null);
      Contract.Ensures(Contract.Result<IObservableParser<TSource, IObservable<TResult>>>() != null);

      return new AllManyObservableParser<TSource, TResult>(parsers);
    }
    ...
    /// or no matches if any of the parsers have no matches.</returns>
    public static IObservableParser<TSource, IObservable<TResult>> All<TSource, TResult>(
      params IObservableParser<TSource, IObservable<TResult>>[] parsers)
    {
      Contract.Requires(parsers != null);
      Contract.Ensures(Contract.Result<IObservableParser<TSource, IObservable<TResult>>>() != null);
    ...
    /// or no matches if any of the parsers have no matches.</returns>
    public static IObservableParser<TSource, IObservable<TResult>> AllUnordered<TSource, TResult>(
      this IEnumerable<IObservableParser<TSource, TResult>> parsers)
    {
      Contract.Requires(parsers != null);
      Contract.Ensures(Contract.Result<IObservableParser<TSource, IObservable<TResult>>>() != null);

      return new AllUnorderedObservableParser<TSource, TResult>(parsers);
    }
      ...
      this IEnumerable<IObservableParser<TSource, IObservable<TResult>>> parsers)
    {
      ...
      return new AllManyUnorderedObservableParser<TSource, TResult>(parsers);
    }
