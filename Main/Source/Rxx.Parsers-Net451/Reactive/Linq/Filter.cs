...
namespace Rxx.Parsers.Reactive.Linq
{
  public static partial class ObservableParser
  {
    ...
    public static IObservableParser<TSource, TResult> IgnoreBefore<TSource, TIgnore, TResult>(
      this IObservableParser<TSource, TIgnore> ignoreParser,
    ...
    public static IObservableParser<TSource, TResult> IgnoreTrailing<TSource, TIgnore, TResult>(
      this IObservableParser<TSource, TResult> parser,
      IObservableParser<TSource, TIgnore> ignoreParser)
    {
      Contract.Requires(parser != null);
      Contract.Requires(ignoreParser != null);
      Contract.Ensures(Contract.Result<IObservableParser<TSource, TResult>>() != null);
