...
{
  /// <summary>
  /// Provides <see langword="static" /> methods for defining <see cref="IObservableParser{TSource,TResult}"/> grammars.
  /// </summary>
  ...
  public static partial class ObservableParser
  {
    ...
    public static IObservableParser<TSource, TResult> Join<TSource, TIntermediate, TResult>(
      this IObservableParser<TSource, IObservable<TIntermediate>> parser,
    ...
    /// <param name="selector">A function that projects the aggregated <see cref="string"/> of each parse result.</param>
    /// <returns>A parser that returns the joined results.</returns>
    public static IObservableParser<TSource, TResult> Join<TSource, TIntermediate, TJoin, TResult>(
      this IObservableParser<TSource, IObservable<TIntermediate>> parser,
