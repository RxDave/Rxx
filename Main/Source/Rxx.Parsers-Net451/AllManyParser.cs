...
{
  internal sealed class AllManyParser<TSource, TResult> : IParser<TSource, IEnumerable<TResult>>
  {
    ...
    #region Constructors
    public AllManyParser(IEnumerable<IParser<TSource, IEnumerable<TResult>>> parsers)
    {
